						...
						<div class=" col-md-12" style="padding:0">               
		                    <div class="card" >
		                        ...
		                        <div class="card-header">
		                            <div class="row">
		                                 <div class="col-md-6"><b>Add Student Information</b></div>
    							...
    							<!-- /.main head-->
		                        <form action="{{url('student/edit/insert')}}" method="post" enctype="multipart/form-data">              
					                      	@csrf              
										...
										<div class="card-body " style="font-size: 14px;">
						                    <div class="form-group row">
                                				...
                                				<div class="col-sm-4">
                                    				<input  style="height: 32px;font-size: 14px;" type="hidden" class="form-control" id="" name="student_id" value="{{$edit_info->id}}">
                                    				<input  style="height: 32px;font-size: 14px;" type="text" class="form-control" id="" name="student_name" value="{{$edit_info->student_name}}" required>
                                				</div>
                             				</div>
						                    ...
						                    <div class="form-group row">
                                				...
                                				<div class="col-sm-4">
                                    				<select style="height: 32px;font-size: 14px;"  class="form-control"  name="gender"  id="gender">
				                                                                      <option value="">--Select--</option>
				                                                                      <option value="{{$edit_info->gender}}"{{($edit_info->gender=='Male'||'Female'||'Other')?"selected":""}}>{{$edit_info->gender}}</option>
                             				...
                             				<div class="form-group row">
                                				...
                                				<div class="col-sm-4">
                                    				<input  style="height: 32px;font-size: 14px;" type="date" class="form-control" id="" value="{{$edit_info->date_of_birth}}" name="date_of_birth" required>
                                				</div>
                             				</div>
                             				...
                             				<div class="form-group row">
                                				...
                                				<div class="col-sm-4">
                                    				<select style="height: 32px;font-size: 14px;"  class="form-control"  name="blood_group"  id="blood" required>
				                                                                      <option value="">--Select--</option>
				                                                                      <option value="{{$edit_info->blood_group}}"{{($edit_info->blood_group=='A+'||'A-'||'B+'||'B-'||'O+'||'O-'||'AB+'||'AB-'||'N/A')?"selected":""}}>{{$edit_info->blood_group}}</option>
                             				...
                             				<div class="form-group row">
                                				...
                                				<div class="col-sm-4">
                                    				<select style="height: 32px;font-size: 14px;"  class="form-control"  name="religion"  id="religion" required>
				                                                                        <option value="">--Select--</option>
				                                                                        <option value="{{$edit_info->religion}}"{{($edit_info->religion=='Islam'||'Hindu'||'Other')?"selected":""}}>{{$edit_info->religion}}</option>
                             				...
                             				<div class="form-group row">
                                				...
                                				<div class="col-sm-4">
                                    				<input  style="height: 32px;font-size: 14px;" type="text" class="form-control" id="" value="{{$edit_info->fathers_name}}" name="fathers_name" required>
                                				</div>
                             				</div>
                             				...
                             				<div class="form-group row">						                    	
                                				...
                                				<div class="col-sm-4">
                                    				<input  style="height: 32px;font-size: 14px;" type="number" placeholder="017XXXXXXXX" class="form-control" id="" value="{{$edit_info->fathers_mobile}}" name="fathers_mobile" required>
                                				</div>
                             				</div>
                             				...
                             				<div class="form-group row">						                    	
                                				...
                                				<div class="col-sm-4">
                                    				<input  style="height: 32px;font-size: 14px;" type="text" class="form-control" id="" value="{{$edit_info->mothers_name}}" name="mothers_name" required>
                                				</div>
                             				</div>
                             				...
                             				<div class="form-group row">						                    	
                                				...
                                				<div class="col-sm-4">
                                    				<input  style="height: 32px;font-size: 14px;" type="number" class="form-control" placeholder="017XXXXXXXX" id="" value="{{$edit_info->mothers_mobile}}" name="mothers_mobile">
                                				</div>
                             				</div>
											...
											<div class="form-group row ">
                                				...
                                				<div class="col-sm-4">
                                    				<input  style="height: 32px;font-size: 14px;" type="text" class="form-control" id="" value="{{$edit_info->present_address}}" name="present_address" required placeholder="Village, P.O, Upozilla, Zilla">
                                				</div>
                             				</div>
                             				...
                             				<div class="form-group row">						                    	
                                				...
                                				<div class="col-sm-4">
                                    				<input  style="height: 32px;font-size: 14px;" type="text" class="form-control" id="" value="{{$edit_info->permanent_address}}" name="permanent_address" placeholder="Village, P.O, Upozilla, Zilla">
                                				</div>
                             				</div>
                             				<div class="form-group row ">
						                    	<div class="col-sm-5"></div>
                                				...
                                				<div class="col-sm-4">
                                					<select style="height: 32px;font-size: 14px;"  class="form-control"  name="class_name"  id="class"  required="required">
                                                             ...
                                                             @foreach ($classlists as $classlist)
                                                                	<option value="{{$classlist->class_name}}"{{($edit_info->class_name==$classlist->class_name)?"selected":""}}>{{$classlist->class_name}}</option>
                                                             @endforeach                                                              
                                         			</select>                                    				
                                				</div>
                             				</div>
                                				...
                                				<div class="col-sm-4">
                                					<select style="height: 32px;font-size: 14px;"  class="form-control"  name="section_id"  id="section"  required="required">
                                                                ...
                                                                @foreach ($sections as $section)
                                                                	<option value="{{$section->id}}"{{($edit_info->section_id==$section->id)?"selected":""}}>{{$section->section_name}}</option>
                                                                @endforeach                                                                                                                             
                                         			</select>                                    				
                                				</div>
                             				</div>
											...
											<div class="form-group row ">	                    	
                                				...
                                				<div class="col-sm-4">
				                                        <select style="height: 32px;font-size: 14px;"  class="form-control"  name="group"  id="group"  required>
				                                                                <option value="">--Select--</option>
				                                                                <option value="{{$edit_info->group}}"{{($edit_info->group=='N/A')?"selected":""}}>N/A</option>
				                                                                <option value="{{$edit_info->group}}"{{($edit_info->group=='Science')?"selected":""}}>Science</option>
				                                                                <option value="{{$edit_info->group}}"{{($edit_info->group=='General')?"selected":""}}>General</option>
				                                                                <option value="{{$edit_info->group}}"{{($edit_info->group=='Humanities')?"selected":""}}>Humanities</option>
				                                         </select> 
				                                    </div>
                             				</div>
											...
											<div class="form-group row">						                    	
                                				...
                                				<div class="col-sm-4">
                                    				<input  style="height: 32px;font-size: 14px;" type="number" class="form-control" id="" value="{{$edit_info->roll}}" name="roll" required>
                                				</div>
                             				</div>
                             				...
                             				<div class="form-group row">						                    	
                                				...
                                				<div class="col-sm-4">
                                    				<input  style="height: 32px;font-size: 14px;" type="number" class="form-control" id="" value="{{$edit_info->registration}}" name="registration">
                                				</div>
                             				</div>
