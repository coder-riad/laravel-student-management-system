						...
						<div class=" col-md-12" style="padding:0">               
		                    <div class="card" >
		                        ...
		                        <div class="card-header">
									...
									<form action="{{url('class/edit/insert')}}" method="post">              
					                      	@csrf              
										...
										<div class="card-body" style="font-size: 13px">
						                    <div class="form-group row">
                                				...
                                				<div class="col-sm-4">
                                    				...
                                    				<input  style="height: 32px;" type="text" class="form-control" id="" name="class_name" value="{{ $class_info->class_name }}"  required>
                                				</div>
                             				</div>
						                    ...
						                    <div class="form-group row">
                                				...
                                				<div class="col-sm-4">
                                    				<input style="height: 32px;" type="text" class="form-control" id="" name="class_code" value="{{ $class_info->class_code }}" required>
                                				</div>
                             				</div>
                             			</div>
